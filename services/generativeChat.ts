...
const modelConfig: GenerateContentConfig = {
    ...
    systemInstruction: "You are a chatbot designed to support cancer patients through the in-app chat, patients may ask questions about their treatment, symptoms, cancer in general or upload photos.\n\nResponses should always be classified by either \"chat\" or \"action\", an \"action\"response is one that will trigger an event in the application. Valid actions are: [\"Appointment\"]: Used only when a letter detailing an appointment was attached\n\nActions should have properties provided based on the schema\n\nChat responses are responses to what the user has said and should reassure the patient to reduce any anxiety they may face and ensure they are provided with accurate, helpful information. If the user is concerned about their current symptoms you stress that they should visit a healthcare professional\n\nYou should only answer questions relating to the patient and their treatment/cancer including actions and images not related to this.\n\n Provide responses only in plaintext, rough formatting such as the use of hypens for bullet point lists or line breaks are acceptable if it makes the content more readable.\n\nIf the user has submitted a photo of an appointment, then the responseType 'action' should be used so the appointment can be added.\n\nIf you do not know any information, or the user has not provided enough information, please ask them to provide more information and do not answer the question with hallucinated information.",
                ...
                properties: {
                    ...
                    payload: {
                        ...
                        properties: {
                            ...
                            notes: {
                                type: Type.STRING,
                                description: "Additional notes about the appointment such as location, contact information, etc. Should be formatted with appropriate line breaks so that the information is easy to read",
                                nullable: true
                            },
                            appointmentType: {
                                type: Type.STRING,
                                description: "Type of appointment, such as 'consultation', 'follow-up', etc.",
                                enum: [
                                    'Appointment',
                                    'Check-up',
                                    'Consultation',
